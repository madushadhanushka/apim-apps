...
describe("Invoke API Product", () => {
    ...
    it("Test Application Sharing", {
        ...
        apiName = `anonymous${Math.floor(Math.random() * (100000 - 1 + 1) + 1)}`;
        apiContext = `anonymous${Math.floor(Math.random() * (100000 - 1 + 1) + 1)}`;
        user1 = `user1_${Math.floor(Math.random() * (100000 - 1 + 1) + 1)}`;
        user2 = `user2_${Math.floor(Math.random() * (100000 - 1 + 1) + 1)}`;
        ...
        cy.location('pathname').then((pathName) => {
            ...
            apiId = uuid;
            appName = `App_${Math.floor(Math.random() * (100000 - 1 + 1) + 1)}`;
